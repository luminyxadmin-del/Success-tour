...
export const signatureFlagships: SignatureFlagship[] = [
  ...
  },
  {
    ...
    gallery: [IMG.riftValley, IMG.elephantClose, IMG.giraffes, IMG.zebra, IMG.lodgeTent],
    audience: [
  ...
  },
  {
    ...
    gallery: [IMG.kilimanjaro, IMG.elephants, IMG.elephantClose, IMG.lion, IMG.savanna],
    audience: [
  ...
  },
  {
    ...
    gallery: [IMG.safariJeep, IMG.savanna, IMG.riftValley, IMG.lion, IMG.elephantClose],
    audience: [
